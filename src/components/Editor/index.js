 ...
 * @Date: 2019-06-03 14:22:54
 * @LastEditTime: 2019-06-03 14:22:54
 * @Description:
 **/
...
class Editor extends React.Component {
    ...
    uploadFn = param => {
        ...
        const successFn = () => param.success({ url: JSON.parse(xhr.responseText).Result });
        const progressFn = event => param.progress((event.loaded / event.total) * 100);
    ...
    render() {
        ...
        const editorProps = {
            ...
            placeholder: this.props.placeholder || '发表文章，记录自己这段时间的学习，技术需要沉淀'
        };
        return (
            <div className="braft-editor">
                <BraftEditor value={editorState} {...editorProps} />
            </div>
        );
    }
}
